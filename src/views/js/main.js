...
//moved varible declaration to outside of loop
...
function updatePositions() {
  ...
  //moved phase declation out side of loop
  var phase;
...
//reduced number of pizzas in background that you cant see
document.addEventListener('DOMContentLoaded', function() {
  var cols = 8;
  var s = 256;
  //moved elem declartion outside of loop
  var elem;
  //created movingPizzas varible and changed query selector to getElementById
